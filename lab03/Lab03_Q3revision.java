    ...
    public static void main(String[] args) {
       ...
       else if(isAdmin)
       {
        ...
        int selected= sc.nextInt(); sc.nextLine();
            ...
            {
                System.out.print("Enter the movie name you want to edit: ");
                String movieToEditOriginal=sc.nextLine();
                String movieToEdit=movieToEditOriginal.replace(" ", "");
                if(!firstMovie.equals(movieToEdit) && !secondMovie.equals(movieToEdit)&& !thirdMovie.equals(movieToEdit) && !fourthMovie.equals(movieToEdit) && !fifthmovie.equals(movieToEdit))
                {
                    System.out.println("The movie is not on the list!");
                }
                else
                {
                    System.out.print("Enter the movies new name: ");
                    String newName=sc.next();
                    System.out.println("Now, "+movieToEditOriginal+" is known as "+newName);
                    movies=movies.replace(movieToEditOriginal, newName);
                    System.out.println(movies);
                }
            }
            else if (selected==4)
